...
//	 
//	 	 for(int i = 3;i>0;i--){
//		 if( Calculate_coordinate(15,30-3*i,0)){
//				 OUT_servo_motor_angel();
//				 SendCMD(0x03,SPPED,0x01,one_servo.now_angle,0x02,two_servo.now_angle,0x03,W_servo.now_angle);
//				HAL_Delay(MS);
...
//   }
  ...
  while (1)
  {
		servo_control();
    /* USER CODE END WHILE */
//    printf(" %d   %d,%d\r\n",vision.ID,vision.data_X,vision.data_Y);
//		HAL_Delay(50);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
